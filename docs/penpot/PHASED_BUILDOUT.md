...
- [x] Switching tokensLib set in the file recolors all 12 page backgrounds — `appliedTokens.fill = color.surface.canvas` per [`docs/penpot/specs/token-fill.json`](specs/token-fill.json)
...
- [ ] [`docs/penpot/verification/phase-1.md`](verification/phase-1.md) committed with verdict
