...
//
// <OcaInitialsAvatar name="Mitchell Admin"/> — circle with the
// first-letter initial; tint hashed from the alphabet bucket palette.

import {Component} from "@odoo/owl";

export class OcaInitialsAvatar extends Component {
    static template = "oca_design_system.OcaInitialsAvatar";
